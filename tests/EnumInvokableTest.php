...
use Suleymanozev\EnumHelper\Exceptions\UndefinedCase;
...
it('throws an error when a nonexistent case is being used for pure enums', function () {
    PureEnum::INVALID();
})->throws(UndefinedCase::class, 'Undefined constant Suleymanozev\EnumHelper\Tests\Support\Enums\PureEnum::INVALID');

it('throws an error when a nonexistent case is being used for backed enums', function () {
    StringBackedEnum::INVALID();
})->throws(UndefinedCase::class, 'Undefined constant Suleymanozev\EnumHelper\Tests\Support\Enums\StringBackedEnum::INVALID');
